...
## Wave 0 — scaffold
- [ ] **T0** Repo scaffold: Cargo, CI (§6.5), `AGENTS.md`/`PLAN.md`/`PROGRESS.md`/`OPEN_QUESTIONS.md`, vendor upstream @ `v0.5.11` into `reference/` (read-only), empty module + test files, `db_equal` oracle, `scripts/capture-golden.sh`.
